...
function animations(){
    ...
    animation('.about', '.page__title-h2_semibold');
    animation('.our-doctor');
    animation('.testimonials', '.page__text');
    animation('.appointment-form', '.page__text');
    animation('.callback', '.page__title-h2');
